...
export default function CollectPage() {
    ...
    const handleVerify = async () => {
        ...
        try {
            ...
            const prompt = `You are an expert in waste management and recycling. Analyze this image and provide your answer in the specified json format only:
        1. Confirm if the waste type matches: ${selectedTask.wasteType}
        2. Estimate if the quantity matches with a 6.5% margin: ${selectedTask.amount}
        ...
        Respond in JSON format like this:
        {
          ...
          "confidence": confidence level as a number between 0 and 1
            ...
            try {
                const cleanedText = text.replace(/```json|```/g, '').trim(); // Remove the backticks and clean up
