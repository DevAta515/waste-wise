...
export default function ReportPage() {
    ...
    const [user, setUser] = useState<{ id: number; email: string; name: string; createdAt: Date; } | null>(null);
    ...
    useEffect(() => {
        const checkUser = async () => {
            if (status === "loading") return; // Don't show toast while session is loading

            if (!session?.user?.email) {
                toast.error("First log in to use features");
                return;
            }
